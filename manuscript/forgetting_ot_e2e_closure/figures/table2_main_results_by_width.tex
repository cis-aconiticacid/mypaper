\begin{table*}[!t]
\centering
\caption{Matched results grouped by initial width. Speedup is
...
\midrule
8 & ImageNet-32 & $n=1024$ & fixed/DC & $1.054\times$ (1.033--1.072) & Sinkhorn time; 3 training seeds \\
...
8 & MetroPT-3 & $n=16384$, lower-workload input & fixed/DC & $2.159\times$ & eight-worker pipeline endpoint; fixed work per worker \\
8 & MetroPT-3 & $n=16384$, higher-workload input & fixed/DC & $3.110\times$ & eight-worker pipeline endpoint; fixed work per worker \\
\midrule
...
16 & MetroPT-3 & $n=32768$, lower-workload input & fixed/DC & $1.616\times$ & one-worker endpoint; equal-host geometric mean \\
16 & MetroPT-3 & $n=16384$, two hosts & fixed/DC & $1.7447\times$ [1.7434, 1.7467] & pipeline endpoint; 6 host--plan observations \\
16 & MetroPT-3 & $n=16384$, four workers & fixed/DC & $1.7455\times$ (1.7453--1.7460) & four-worker makespan; 3 registered plans \\
16 & MetroPT-3 & $n=8192$, lower-workload input & fixed/DC & $2.316\times$ & one-worker endpoint; equal-host geometric mean \\
\bottomrule
\end{tabular}
\end{table*}
