...
\midrule
Batched verifier checks & serial / batched verifier & OT stage & 1.133$\times$ & 24/24 wins \\
Preliminary current-marginal check & verifier only / preliminary check & OT stage & 1.105$\times$ & 24/24 wins \\
...
{\scriptsize The batched verifier-check and preliminary current-marginal-check
