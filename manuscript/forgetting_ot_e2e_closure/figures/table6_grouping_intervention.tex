...
padding is $W\max_s q_s/\sum_s q_s-1$. The dynamic-update ratio divides the
dynamic update count by the fixed-width count. Values aggregate over windows;
...
\begin{tabular}{@{}lcccc@{}}
\toprule
Grouping & $H_q$ & Padding & Dynamic updates & Fixed/dynamic \\
\midrule
