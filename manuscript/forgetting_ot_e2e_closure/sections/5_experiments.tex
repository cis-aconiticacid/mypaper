...
tolerance, verifier-check schedule, two-marginal verifier, and consumer fixed.
...
\end{figure*}
\input{figures/table_main_results_by_width}
...
verifier candidates, verify 16 candidates, and launch 32 plan-application
...
\input{figures/table4_eight_gpu_decomposition}
...
\input{figures/table5_imagenet_quality}
...
paired units; consumer TV checks differences in outputs against the tight
reference.}
...
\input{figures/table8_grouping_intervention}
